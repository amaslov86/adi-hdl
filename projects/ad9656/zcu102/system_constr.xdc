...
#set_property  -dict {PACKAGE_PIN  Y4  IOSTANDARD LVCMOS18} [get_ports ref_clk0_p]                     ; ## G06  FMC_HPC0_LA00_CC_P
#set_property  -dict {PACKAGE_PIN  Y3  IOSTANDARD LVCMOS18} [get_ports ref_clk0_n]                     ; ## G07  FMC_HPC0_LA00_CC_N
...
create_clock -name rx_ref_clk     -period  4.00 [get_ports ref_clk0_p]
create_clock -name rx_div_clk     -period  4.00 [get_pins i_system_wrapper/system_i/util_ad9656_xcvr/inst/i_xch_0/i_gthe4_channel/RXOUTCLK]
