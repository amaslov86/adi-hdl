...
set_property -dict {PACKAGE_PIN AE4  IOSTANDARD LVCMOS18} [get_ports rmii_rx_dv_a]                 ; ## H14 FMC_HPC1_LA07_N
...
set_property -dict {PACKAGE_PIN AH11 IOSTANDARD LVCMOS18} [get_ports rmii_rx_dv_b]                 ; ## H29 FMC_HPC1_LA24_N
