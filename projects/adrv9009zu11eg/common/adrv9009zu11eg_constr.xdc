...
set_property PACKAGE_PIN H2 [get_ports {rx_data_a_p[0]}]
set_property PACKAGE_PIN H1 [get_ports {rx_data_a_n[0]}]
set_property PACKAGE_PIN H6 [get_ports {tx_data_a_p[0]}]
set_property PACKAGE_PIN H5 [get_ports {tx_data_a_n[0]}]
set_property PACKAGE_PIN G4 [get_ports {rx_data_a_p[1]}]
set_property PACKAGE_PIN G3 [get_ports {rx_data_a_n[1]}]
set_property PACKAGE_PIN G8 [get_ports {tx_data_a_p[1]}]
set_property PACKAGE_PIN G7 [get_ports {tx_data_a_n[1]}]
set_property PACKAGE_PIN F2 [get_ports {rx_data_a_p[2]}]
set_property PACKAGE_PIN F1 [get_ports {rx_data_a_n[2]}]
set_property PACKAGE_PIN F6 [get_ports {tx_data_a_p[2]}]
set_property PACKAGE_PIN F5 [get_ports {tx_data_a_n[2]}]
set_property PACKAGE_PIN E4 [get_ports {rx_data_a_p[3]}]
set_property PACKAGE_PIN E3 [get_ports {rx_data_a_n[3]}]
set_property PACKAGE_PIN E8 [get_ports {tx_data_a_p[3]}]
set_property PACKAGE_PIN E7 [get_ports {tx_data_a_n[3]}]
...
set_property -dict {PACKAGE_PIN AJ20 IOSTANDARD LVDS} [get_ports rx_sync_a_n]
set_property -dict {PACKAGE_PIN AJ21 IOSTANDARD LVDS} [get_ports rx_sync_a_p]
set_property -dict {PACKAGE_PIN AT16 IOSTANDARD LVDS} [get_ports rx_os_sync_a_n]
set_property -dict {PACKAGE_PIN AT17 IOSTANDARD LVDS} [get_ports rx_os_sync_a_p]
set_property -dict {PACKAGE_PIN AL20 IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports tx_sync_a_n]
set_property -dict {PACKAGE_PIN AK20 IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports tx_sync_a_p]
set_property -dict {PACKAGE_PIN AG19 IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports tx_sync_a_1_n]
set_property -dict {PACKAGE_PIN AG20 IOSTANDARD LVDS DIFF_TERM_ADV TERM_100} [get_ports tx_sync_a_1_p]
...
set_property -dict {PACKAGE_PIN AL17 IOSTANDARD LVCMOS18}  [get_ports spi_csn_adrv9009_a]
set_property -dict {PACKAGE_PIN AL18 IOSTANDARD LVCMOS18}  [get_ports spi_csn_adrv9009_b]
