...
module system_top (
  ...
  input               sfp_rec_clk_n,
  input               sfp_rec_clk_p,
  input               sfp_rx_0_gt_port_0_n,
  input               sfp_rx_0_gt_port_0_p,
  output              sfp_tx_0_gt_port_0_n,
  output              sfp_tx_0_gt_port_0_p,
  ...
  system_wrapper i_system_wrapper (
    ...
    .gpio_o (gpio_o),
    .gpio_t (gpio_t),
    .sfp_ref_clk_0_clk_n(sfp_rec_clk_n),
    .sfp_ref_clk_0_clk_p(sfp_rec_clk_p),
    .sfp_rx_0_gt_port_0_n(sfp_rx_0_gt_port_0_n),
    .sfp_rx_0_gt_port_0_p(sfp_rx_0_gt_port_0_p),
    .sfp_tx_0_gt_port_0_n(sfp_tx_0_gt_port_0_n),
    .sfp_tx_0_gt_port_0_p(sfp_tx_0_gt_port_0_p),
