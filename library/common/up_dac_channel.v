...
module up_dac_channel #(
  ...
  reg     [ 7:0]  up_dac_src_chan_sel = {COMMON_ID-1,CHANNEL_ID};
  ...
  always @(negedge up_rstn or posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      up_dac_pn_enb <= 'd0;
      up_dac_data_sel <= 'd0;
      up_dac_src_chan_sel <= {COMMON_ID-1,CHANNEL_ID};
    end else begin
      if ((up_wreq_s == 1'b1) && (up_waddr[3:0] == 4'h5)) begin
      ...
      if ((up_wreq_s == 1'b1) && (up_waddr[3:0] == 4'h6)) begin
        ...
        up_dac_src_chan_sel <= up_wdata[15:8];
       end
    end
  end
    ...
    if (up_rstn == 0) begin
      ...
      if (up_rreq_s == 1'b1) begin
        case (up_raddr[3:0])
          ...
          4'h6: up_rdata_int <= { 16'd0, up_dac_src_chan_sel, 4'b0, up_dac_data_sel_m};
  ...
  up_xfer_cntrl #(.DATA_WIDTH(176)) i_xfer_cntrl (
    .up_rstn (up_rstn),
    .up_clk (up_clk),
