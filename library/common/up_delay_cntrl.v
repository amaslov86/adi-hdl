...
module up_delay_cntrl #(
  ...
  // TODO  - is this synthesized optimally 
  assign up_rdata_s = up_drdata >> up_raddr[7:0];
  ...
  assign up_dinitdata_s[((n*DRP_WIDTH)+DRP_WIDTH-1):(n*DRP_WIDTH)] = INIT_DELAY;
  end
  ...
  assign up_dwdata_s[((n*DRP_WIDTH)+DRP_WIDTH-1):(n*DRP_WIDTH)] = (up_waddr[7:0] == n) ?
    up_wdata[DRP_WIDTH-1:0] : up_dwdata_int[((n*DRP_WIDTH)+DRP_WIDTH-1):(n*DRP_WIDTH)];
  end
