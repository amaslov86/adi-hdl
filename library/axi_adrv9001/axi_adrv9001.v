...
module axi_adrv9001 #(
  ...
  axi_ad9001_core #(
    ...
    .adc_2_enable_i (adc_2_enable_i),
    .adc_2_data_i (adc_2_data_i),
    .adc_2_enable_q (adc_2_enable_q),
    .adc_2_data_q (adc_2_data_q),
  ...
  assign dac_1_clk = tx1_clk;
  assign dac_2_clk = tx2_clk;

  assign adc_1_rst = rx1_rst;
  assign adc_2_rst = rx2_rst;
  assign dac_1_rst = tx1_rst;
  assign dac_2_rst = tx2_rst;
