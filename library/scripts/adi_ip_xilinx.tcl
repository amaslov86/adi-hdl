...
proc adi_add_bus_clock {clock_signal_name bus_inf_name {reset_signal_name ""} {reset_signal_mode "slave"}} {
  ...
  set clock_inf [ipx::add_bus_interface $clock_signal_name [ipx::current_core]]
  ...
  set_property display_name $clock_signal_name $clock_inf
  ...
  if { $reset_signal_name != "" } {
    ...
    set reset_inf [ipx::add_bus_interface $reset_signal_name [ipx::current_core]]
    ...
    set_property display_name $reset_signal_name $reset_inf
  ...
  ipx::associate_bus_interfaces -busif $bus_inf_name -clock $clock_signal_name -reset $reset_signal_name [ipx::current_core]
}
