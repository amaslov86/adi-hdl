...
module loopback_64b_tb;
  ...
  wire [7:0] tx_cfg_lmfc_lemc_offset;
  ...
  jesd204_tx_static_config #(
    ...
    .cfg_lmfc_lemc_offset(tx_cfg_lmfc_lemc_offset),
  ...
  wire [7:0] rx_cfg_lmfc_lemc_offset;
  ...
  jesd204_rx_static_config #(
    ...
    .cfg_lmfc_lemc_offset(rx_cfg_lmfc_lemc_offset),
  ...
  always @(posedge clk) begin
    if (reset == 1'b1) begin
      data_mismatch <= 1'b0;
    end else if (rx_valid_d1 == 1'b1) begin
  ...
  always @(*) begin
    if (rx_valid !== 1'b1 || tx_ready !== 1'b1 || data_mismatch == 1'b1 ) begin
      failed <= 1'b1;
    end else begin
      failed <= 1'b0;
    end
